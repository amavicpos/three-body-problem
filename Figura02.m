%% Figure 02: Circle around complex rings, modified Kepler-16 system
...
m1=0.6674*MS ; m2=0.6674*MS ; d=0.22*2*AU ; T=2*41.079*day ; % orbit % !!! Different m2, d, T
r1=d*m2/(m1+m2) ; r2=d*m1/(m1+m2) ; % get stars positions
v1=2*pi*r1/T ; v2=2*pi*r2/T ; % get stars velocities
m3=0.6674*MS/2 ; r3=0.7048*2*AU ; T3=228.776*2*day ; v3=2*pi*r3/T3 ; % planet % !!! Different m3, r3, T3
...
legend('Estrella Kepler-16A','Estrella Kepler-16A','Tercera estrella');
